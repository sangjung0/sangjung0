...
- Undergraduate Research Assistant, SE & AI Lab, Department of Computer Engineering, Yeungnam University, Korea (Mar. 2024 ~ Feb. 2026)
- M.S. Student Researcher, SE & AI Lab, Department of Computer Engineering, Yeungnam University, Korea (Mar. 2026 ~ Present)

---

## Publications

1. [**Sang-Jeong Kim, Dong-Gun Lee, Yeong-Seok Seo**, "A Method for Real-Time Face Detection through Optical Flow and Scale Resampling", ASK 2024 (Annual Symposium of KIPS), Korea Information Processing Society (KIPS), Pyeongchang, Korea (May. 2024) - Conference paper](https://koreascience.or.kr/article/CFKO202422572337673.page)  
...
- **Academic Excellence Scholarship**, Yeungnam University, Korea (Aug. 2025)  
- **Academic Excellence Scholarship**, Yeungnam University, Korea (Feb. 2025)  
- **Academic Excellence Scholarship**, Yeungnam University, Korea (Aug. 2024)  
- **Excellence Award**, 3rd Open Source Competition, Yeungnam University, Korea (Jun. 2024)  
- **Academic Excellence Scholarship**, Yeungnam University, Korea (Feb. 2024)  
- **Excellence Award**, 2nd Open Source Competition, Yeungnam University, Korea (Dec. 2023)  
...
- C, C++, Java, TypeScript, JavaScript, Python, Kotlin  

### Frameworks & Libraries
- React, Spring Boot, FastAPI, Express
- TensorFlow, OpenCV, scikit-learn
- NumPy, pandas

### Development & DevOps Tools
- Docker, AWS(EC2), Google Cloud, Cloudflare  
- MySQL, Firebase  
